...
/* ===== BEGIN dev_thorskins_campaign_armies.js ===== */
(() => {
  const TYPE = 'thorskins_island';
  const POINTS = 1500;
  let viewedCampaignId = null;
...
;
/* ===== END dev_thorskins_campaign_armies.js ===== */
